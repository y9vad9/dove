...
import com.dove.server.utils.authorization.UserAuthorization
...
val <TRoute : OpenAPIRoute<TRoute>> TRoute.user get() = authorization(UserAuthorization)

@ContextDsl
inline fun <TRoute : OpenAPIRoute<TRoute>> TRoute.userAuthorized(
    crossinline block: TRoute.() -> Unit
): TRoute = authorized(UserAuthorization, block)
